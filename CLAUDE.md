...
- [ ] Backend — Decap CMS + Resend (RFQ form hiện dùng `mailto:`) — sau khi frontend hoàn chỉnh
...
**File chưa commit:** (không còn — đã push tới `9983877`). Script crop tạm ở scratchpad phiên (require sharp bằng path tuyệt đối `C:/Mekong/Du-an-web/04-Source/node_modules/sharp`, path Windows forward-slash).
