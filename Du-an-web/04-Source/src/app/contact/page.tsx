...
const { hero, salesTeam, rfqChecklist } = CONTACT;
const { company } = SITE;
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div>
                ...
                <div className="space-y-3 text-sm">
                  ...
                  <div className="flex gap-3 items-center">
                    ...
                    <a href={`tel:${company.phoneHref}`} className="text-navy font-semibold hover:text-teal-dark transition-colors">
                      {company.phone}
                    </a>
                  ...
                  <div className="flex gap-3 items-center">
                    <span className="text-lg">📠</span>
                    <span className="text-navy/70">{company.fax}</span>
              ...
              <div>
                ...
                <div className="space-y-3">
                  {salesTeam.map(({ name, role, phone, email, priority }) => (
                    <div
                      key={email}
              ...
              <div className="bg-slate-light rounded-xl p-6 border border-slate-border">
                <p className="font-heading font-bold text-navy text-sm mb-3">
                  {rfqChecklist.heading}
                </p>
                <ul className="space-y-1.5 text-navy/60 text-sm">
                  {rfqChecklist.items.map((item) => (
                    <li key={item}>• {item}</li>
                  ))}
                </ul>
              </div>
