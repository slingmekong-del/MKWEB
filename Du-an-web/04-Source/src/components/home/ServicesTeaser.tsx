...
const { servicesTeaser } = HOME;

// Icon glyphs stay in code (inline SVG can't live in CMS JSON); the CMS-editable
// `iconKey` on each service selects one of these.
...
const SERVICES = servicesTeaser.services;
